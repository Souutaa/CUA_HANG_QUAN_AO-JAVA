 ...
 * @author Quang Long
 */
public class CHONSP_VIEW extends javax.swing.JFrame {
    ...
    private void btnCHONActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCHONActionPerformed
        ...
        if (i >= 0) {
            ...
            PHIEUNHAPHANG_VIEW.jtfMASP.setText(String.valueOf(tableModel.getValueAt(i, 0)));
            this.dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CHONSP_VIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CHONSP_VIEW().setVisible(true);
            }
        });
    }
