 ...
 * @author Quang Long
 */
public class CHONNV_VIEW2 extends javax.swing.JFrame {
    ...
    private void btnCHONActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCHONActionPerformed
        ...
        if (i >= 0) {
            ...
            HOADON_VIEW.jtfMANV.setText(String.valueOf(tableModel.getValueAt(i, 0)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CHONNV_VIEW2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CHONNV_VIEW2().setVisible(true);
            }
        });
    }
